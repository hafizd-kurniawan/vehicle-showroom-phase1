...
```bash
git remote add encore encore://vehicle-showroom-phase1-yc62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/vehicle-showroom-phase1-yc62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/vehicle-showroom-phase1-yc62/settings/integrations/github)
