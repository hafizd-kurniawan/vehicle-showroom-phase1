...
import RepairsManagementPage from './pages/RepairsManagementPage';
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route 
        path="/repairs" 
        element={user && (user.role === 'admin' || user.role === 'mechanic') ? <RepairsManagementPage /> : <Navigate to="/dashboard" replace />} 
      />
      <Route 
        path="/" 
